                ...
                render={({ field: { value, onChange } }) => {
                    ...
                    return (
                        <input
                            ...
                            onFocus={handleFocus}
                            onBlur={handleBlur}
                            className={`shadow border-2 border-bgNextStepBtn rounded py-3 px-3 w-full leading-tight focus:outline-none text-gray-700 ${style} ${hasFocus && floatingLabel ? 'bg-transparent' : 'bg-white'}`}
                        />
                    );
                }}
            />
